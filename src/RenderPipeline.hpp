...
struct alignas(32) RenderCommand final {
    float x1, y1;
    float x2, y2;   // 사각형의 크기나, 선의 끝점 좌표로 재사용
    uint32_t type;  // 0: Circle, 1: Rectangle, 2: Line
    Color color;
};
