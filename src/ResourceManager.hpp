...
inline void ResourceManager::PreloadResources() noexcept{
    ...
    m_textures[static_cast<size_t>(TextureID::Background)] = TextureHandle("resources/background.png", Config::WindowWidth, Config::WindowHeight, MAGENTA);
    
    // [수정됨] Config에 정의된 물리적 크기에 맞춰 픽셀 리사이징 및 투명화 적용
    m_textures[static_cast<size_t>(TextureID::Paddle)] = TextureHandle("resources/paddle.png", static_cast<int>(Config::PaddleWidth), static_cast<int>(Config::PaddleHeight));
    m_textures[static_cast<size_t>(TextureID::Brick)] = TextureHandle("resources/brick.png", static_cast<int>(Config::BrickWidth), static_cast<int>(Config::BrickHeight));
    ...
    m_textures[static_cast<size_t>(TextureID::BallFrame0)] = TextureHandle("resources/ball_0.png", ballDiameter, ballDiameter);
    m_textures[static_cast<size_t>(TextureID::BallFrame1)] = TextureHandle("resources/ball_1.png", ballDiameter, ballDiameter);
    m_textures[static_cast<size_t>(TextureID::BallFrame2)] = TextureHandle("resources/ball_2.png", ballDiameter, ballDiameter);

    // [Chapter 43 추가] 사운드 파일 Pre-load (디스크 I/O 완전 차단)
    m_sounds[static_cast<size_t>(SoundID::Hit)] = SoundHandle("resources/hit.wav");
    m_sounds[static_cast<size_t>(SoundID::Break)] = SoundHandle("resources/break.wav");
    m_sounds[static_cast<size_t>(SoundID::GameOver)] = SoundHandle("resources/gameover.wav");
}